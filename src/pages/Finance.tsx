            ...
            <div className="xl:col-span-2 space-y-4">
              <Card className="border-border bg-card">
                <CardHeader className="border-b border-border px-5 py-4">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-sm font-semibold">
                      SAP S/4HANA Migration Progress
                    </CardTitle>
                    <span className="text-[11px] text-muted-foreground">
                      Target: Full cutover Q4 2027
                    </span>
                  </div>
                </CardHeader>
                <CardContent className="space-y-5 px-5 py-5">
                  {MIGRATION_TRACKS.map((track) => (
              ...
              {/* Custom programs rationalization */}
              <Card className="border-border bg-card">
                <CardHeader className="border-b border-border px-5 py-4">
                  <CardTitle className="text-sm font-semibold">
                    Custom Program Rationalization (300+)
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                  <Table>
                    <TableHeader>
                      <TableRow className="border-border hover:bg-transparent">
                        {["Program", "Domain", "Action", "SAP Equivalent", "Status"].map(
                          (h) => (
                            <TableHead
                              key={h}
                              className="h-9 px-5 text-[11px] font-semibold text-muted-foreground"
                    ...
                    <TableBody>
                      {[
                        {
                          program: "Legacy Pricing Calc v1",
                          domain: "SD/Trading",
                          action: "Retire",
                          sap: "S/4 Pricing Conditions",
                          status: "Complete",
                        },
                        {
                          program: "Gas Volume Tracker",
                          domain: "MM",
                          action: "Migrate",
                          sap: "S/4 Inventory Mgmt",
                          status: "In Progress",
                        },
                        {
                          program: "Interco. Netting Tool",
                          domain: "FI",
                          action: "AI Replace",
                        ...
                        {
                          program: "Tanker Dispatch (ERP)",
                          domain: "TM",
                          action: "Integrate EOS",
                          sap: "S/4 TM Integration",
                          status: "Planned",
                        },
                        {
                          program: "Take-or-Pay Accrual",
                          domain: "CO",
                          action: "Automate",
                          sap: "S/4 Contract Acctg",
                          status: "In Progress",
                        },
                      ].map((row) => (
                        <TableRow
            ...
            <div className="space-y-4">
              <Card className="border-border bg-card">
                ...
                <CardContent className="p-0">
                  {[
                    ...
                    {
                      label: "Custom pgms. migrated",
                      value: "124 / 300+",
                      color: "text-accent",
                      Icon: Layers,
                    },
                    {
                      label: "Legal entities live",
                      value: "14 / 38",
                      color: "text-chart-3",
                      Icon: Building2,
                    },
                    {
                      label: "Data migration accuracy",
                      value: "99.97%",
                      color: "text-chart-2",
                      Icon: CheckCircle2,
                    },
              ...
              <Card className="border-border bg-card">
                ...
                <CardContent className="space-y-3 px-5 py-4">
                  {[
                    {
                      label: "Phase 1 — FI/CO Core",
                      detail: "India · Complete",
                      status: "complete",
                    },
                    {
                      label: "Phase 2 — SD/MM",
                      detail: "APAC · In progress",
                      status: "active",
                    },
                    {
                      label: "Phase 3 — TM / EWM",
                      detail: "Q3 2026",
                      status: "planned",
                    },
                    {
                      label: "Phase 4 — EMEA / Americas",
                      detail: "Q2 2027",
                      status: "planned",
                    },
                    {
                      label: "Phase 5 — Full Cutover",
                      detail: "Q4 2027",
                      status: "planned",
                    },
                  ].map((m) => (
